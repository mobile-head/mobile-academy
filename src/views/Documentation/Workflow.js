              ...
              <Card>
                ...
                <CardBody>
                  <p>
                    ...
                    <br />
                    <hr />
                    <h7 id="methodologies" class="font-weight-bold">
                      Metodologias
                    </h7>
                    <p>
                      Atuamos com a metodologia ágil{" "}
                      <h7 class="text-muted">Scrum</h7> visando trabalhar de
                      forma conectada com todos os times com o objetivo de
                      chegar a soluções complexas.
                    </p>
                    <p>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            processos de trabalho trazendo qualidade para o
                            time, visa também criar novas ferramentas, gerar
                            informação precisa sobre eventos que precisamos
                            manter conhecimento, essas tarefas entram em ação
                            sempre que tarefas primárias estão aguardando alguma
                    ...
                    <p>
                      Abaixo vamos ver qual o status correto para cada situação
                      em que a demanda se encontra:
                    </p>
                    <Table striped hover>
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            ...
                            User e retornou a backlog até ser atendida
                            novamente.
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            devido estar aguardando informações, ou outra task
                            que bloqueia esta a ser finalizada.
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            codeReview e a validação técnica do Tech Lead, agora
                            o retorno da task é passado para o Key User caso
                            houver para aguardar a validação do mesmo, em alguns
                            casos será necessário gerar apk em qas e enviá-la
                            para o Key User.
                          </td>
                        </tr>
                        <tr>
                    ...
                    <br />
                    <hr />
                    <h7 id="workflowBitbucket" class="font-weight-bold">
                    ...
                    <p>
                      ...
                      que não estejam totalmente revisadas em sua implementação
                      e testadas tanto em sua funcionalidade técnica quanto em
                      relação a sua regra de negócio em relação aos requisitos
                      do Key User.
                    </p>
                    <h7 class="text-muted font-weight-bold">
                      Branches principais
                    ...
                    <p>
                      Atuamos de modo geral com 3 branchs principais, abaixo
                      listo quais são, suas descrições e atribuições.
                    </p>
                    <Table striped hover>
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            se em dev e após a resolução da atividade realizamos
                            o merge com qas, onde os testes e o controle de
                            qualidade a partir do Key User, ou o time de QA é
                            iniciado.
                          </td>
                          <td>
                            Sempre que recebe commit ou recebe um merge, é
                            executada uma pipeline que realizará a criação de
                            uma apk que posteriormente poderá ser utilizada para
                            ser enviada para o Key User's ou QA's.
                          </td>
                        </tr>
                        <tr>
                          <td className="text-secondary">PRD</td>
                          <td>
                            Branch default de Production, esta branch é onde
                            temos todo o nosso código que espelhará o nosso
                            projeto em produção, não temos o costume de realizar
                            alterações a partir desta branch, os casos que se
                            ocorre isto são específicos e devem ser acordados.
                          </td>
                          <td>
                            Sempre que recebe commit ou recebe um merge, é
                            executada uma pipeline que realizará a criação de
                            uma aab que posteriormente poderá ser utilizada para
                            ser enviada para a Play Store.
                          </td>
                        </tr>
                      </tbody>
                    </Table>
                    ...
                    <p>
                      ...
                      branch a partir de DEV com o mesmo ID do Jira, como
                      exemplo, se temos uma atividade com o ID EVOLOG-3040 então
                      teríamos algo assim:
                    </p>
                    <pre>
                      <SyntaxHighlighter
                    ...
                    <p>
                      Após o término da atividade deve ser criado um pull
                      request da branch auxiliar pra dev, o Tech Lead irá
                      realizar o code review e caso validado concluirá o merge.
                    </p>
                  </p>
                </CardBody>
              </Card>
                ...
                <CardBody>
                  <p>
                    ...
                    <ul>
                      ...
                      <li>
                        <a className="text-muted" href="#methodologies">
                          Metodologias
                        </a>
                      </li>
