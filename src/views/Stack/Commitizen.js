...
class Commitizen extends Component {
  render() {
    return (
      <>
        <PanelHeader size="sm" />
              ...
              <Card>
                ...
                <CardBody>
                  <p>
                    ...
                    <h7 id="whyCommitzen" class="font-weight-bold">
                      O que é e porque utilizar o commitizen
                    </h7>
                    <p>
                      O Commitizen é um estruturador de commits que permite que
                      seja definido um padrão para o corpo do commit, auxiliando
                      o desenvolvedor a fornecer todas as informações que
                      precisamos para ter um commit que nos dê uma informação
                      concisa da tarefa realizada, o commitizen também pode ser
                      integrado com ferramentas para automatizar o processo de
                      upgrade da versão do app baseado nos tipos de commit. O
                      Commitizen nos traz benefícios como:
                    </p>

                    <ul>
                      <li>Auxiliar na padronização dos commits do projeto.</li>
                      <li>
                        Validar se todas as informações que precisamos estão
                        sendo fornecidas pelo desenvolvedor, como por exemplo
                        qual o tipo de commit {"("}bug fix, nova feature, etc
                    ...
                    <h7 id="commitzenIntegration" class="font-weight-bold">
                    ...
                    <p>
                      ...
                      que tem uma integração bem interessante com o Jira que
                      está presente na nossa stack:
                    </p>
                    ...
                    <p>
                      ...
                      basicamente é uma vinculação com o adapter que instalamos,
                      a melhor forma de fazer isso é criando uma propriedade
                      dentro do nosso package.json que por default é
                      automaticamente identificada pelo commitizen, após a
                      última propriedade já declarada dentro do package.json do
                      projeto adicione o seguinte código:
                    </p>
                    ...
                    <br />
                    <br />
                    <h7 id="commitzenHuskyIntegration" class="font-weight-bold">
                      Integrando o commitizen com Husky
                    </h7>

                    <p>
                      O commitzen e o adapter estão configurados mas para termos
                      o uso que queremos precisamos integrar o commitizen ao
                      Husky para que sempre que fizermos um commit, o Husky
                      dispare o hook{" "}
                      <h7 class="text-muted">prepare-commit-message</h7> que é
                      responsável pela preparação da mensagem do nosso commit,
                    ...
                    <br />
                    <h7 id="huskyInAction" class="font-weight-bold">
                      Husky em ação
                    </h7>

                    <p>
                      Para vermos o commitzen em ação apenas execute o comando{" "}
                      <h7 class="text-muted">git commit</h7> e ele será
                      disparado para nos auxiliar com a criação da nossa
                      mensagem:
                    </p>
              ...
              <Card className="card-user">
                ...
                <CardBody>
                  <p>
                    ...
                    <ul>
                      <li>
                        <a className="text-muted" href="#whyCommitzen">
                          O que é e porque utilizar o commitizen
                        </a>
                      </li>
                      <li>
                        <a className="text-muted" href="#commitzenIntegration">
                          Integrando o commitizen com o projeto
                        </a>
                      </li>
                      <li>
                        <a
                          className="text-muted"
                          href="#commitzenHuskyIntegration"
                        >
                          Integrando o commitizen com Husky
                        </a>
                      </li>
                      <li>
                        <a className="text-muted" href="#huskyInAction">
                          Husky em ação
                        </a>
                      </li>
                    </ul>
