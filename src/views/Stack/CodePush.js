              ...
              <Card>
                ...
                <CardBody>
                  <p>
                    ...
                    <h7 id="whyCodePush" class="font-weight-bold">
                      O que é o CodePush e porque utilizá-lo
                    </h7>
                    <p>
                      O codePush é um serviço de deployment para react native do
                      App Center, ele não funciona com código nativo
                      (Android/iOS) e react native ao mesmo tempo, ou seja,
                      sempre que for alterado algo em código nativo ou
                      adicionada alguma biblioteca que contém código nativo,
                      será necessário fazer deploy a partir das Web Stores(Play
                      Store/App Store) porque é necessário que esse código seja
                      compilado, algo que o CodePush não realizará devido nosso
                      projeto estar configurado para utilizar o react-native,
                      caso seja utilizado somente código baseado em react-native
                      é possível realizar deploy pelo CodePush de forma muito
                      rápida, isso significa que conseguimos reduzir o tempo da
                      entrega de melhorias e bugfix para o usuário, de dias para
                      minutos, sem a necessidade de passar pela burocracia e
                      tempo de aprovação da playstore.
                    </p>
                    <br />
                    <h7 id="createAppCenterProject" class="font-weight-bold">
                    ...
                    <br />
                    <p>
                      Agora preencha os dados necessários como nome do
                      aplicativo + OS, a Release Type não é importante para nós
                      já que criamos uma divisão de ambientes dentro do projeto
                      que também acaba definindo a Release Type do ambiente, em
                      OS selecione se está criando para Android ou iOS e em
                      Platform selecione React Native, caso o projeto já tiver
                      um ícone o defina para o projeto do AppCenter também. Após
                      isso clique em "Add new App" e o novo projeto será criado.
                    </p>
                    <div>
                      <img
                        height="600px"
                    ...
                    <br /> <br />
                    <h7 id="createEnvironments" class="font-weight-bold">
                    ...
                    <p>
                      ...
                      ambientes de deploymennt diferentes baseado em qual
                      ambiente nosso aplicativo está sendo executado.
                    </p>
                    <p>
                      ...
                      os ambientes clicando em "New Deployment", informe o nome
                      do deployment e depois clique em "Save". No fim deste
                      processo teremos algo semelhante a isto:
                    </p>
                    <div>
                      <img
                        height="350px"
                    ...
                    <br /> <br />
                    <h7 id="environmentsIntegration" class="font-weight-bold">
                      Integrando ambientes de deployment com os ambientes do app
                    </h7>
                    <br />
                    <p>
                      Já temos nossos ambientes de deployment criados, agora
                      podemos integrá-los com nossos respectivos ambientes
                      dentro do nosso app, acessaremos as pastas dentro de
                    ...
                    <p>
                      ...
                      modo debug, se ele não existisse só conseguiria-mos
                      acessar o ambiente prd em modo release.
                    </p>
                    <br />
                    <h7 id="installCodePush" class="font-weight-bold">
                      Instalando o Code Push dentro do projeto
                    </h7>
                    <br />
                    <p>
                      Caso o Code Push não esteja instalado no projeto, execute
                      o comando a abaixo para realizar a instalação:
                    </p>
                    <pre>
                      <SyntaxHighlighter
                        language="js"
                    ...
                    <p>
                      ...
                      estão presentes no build.gradle, para isso vá para o
                      arquivo android/app/build.gradle, e verifique se dentro da
                    ...
                    <p>
                      Agora dentro do arquivo android/settings.gradle verifique
                      se existe o seguinte código, caso não exista o adicione:
                    </p>
                    <pre>
                      <SyntaxHighlighter
                        language="js"
                    ...
                    <br />
                    <h7 id="codePushConfiguring" class="font-weight-bold">
                      Configurando CodePush para lidar com as atualizações em
                      tempo real
                    </h7>
                    <br />
                    <p>
                      Agora dentro do arquivo MainApplication.java vamos
                      importar e configurar o CodePush para saber de onde obter
                      o bundle(arquivo minificado contendo as alterações da
                      nossa atualização) de cada ambiente. Importe o CodePush
                      dentro do arquivo assim:
                    </p>
                    <pre>
                      <SyntaxHighlighter
                        language="js"
                    ...
                    <br />
                    <h7 id="whenUpdate" class="font-weight-bold">
                      Definindo quando será verificado e instalado atualizações
                      do CodePush
                    </h7>
                    <p>
                      ...
                      precisamos editar o arquivo main/App.js. Importe o
                      codePush assim:
                    </p>
                    <pre>
                      <SyntaxHighlighter
                        ...
                        PreTag="div"
                        children={
                          CodeExamplesCodePush.importCodePushReactNative
                        }
                      />
                    </pre>
                    <p>
                    ...
                    <pre>
                      <SyntaxHighlighter
                        ...
                        PreTag="div"
                        children={
                          CodeExamplesCodePush.exportCodePushReactNative
                        }
                      />
                    </pre>
                    <p>
                      ...
                      caso haja, uma release. A constante ON_APP_RESUME define
                      que toda vez que o aplicativo for aberto ou minimizado e
                      maximizado novamente a aplicação irá realizar um
                      verificação/instalação de novas releases para o ambiente
                      em que o app está rodando.
                    </p>
                    <br />
                    <h7 id="releaseUpdate" class="font-weight-bold">
                      Liberando atualizações pelo Code Push
                    </h7>
                    <br />
                    <p>
                      Agora que o nosso projeto está configurado podemos liberar
                      atualizações pelo Code Push caso o usuário já esteja com
                      uma apk/aab instalada em seu dispositivo com toda essa
                    ...
                    <p>
                      ...
                      <dl>
                        ...
                        <dd>
                          Define para qual ambiente de deployment essa
                          atualização deve ser liberada.
                        </dd>
                        <dt>
                        ...
                        <dd>
                          ...
                          atualização será lançada, o * define que qualquer
                          versão já existente do app será atualizado com essa
                          release. Caso queire lançar para uma versão específica
                          execute o comando especificando o número da versão.
                        </dd>
                        <dt>-m</dt>
                        <dd>
                          Define se a atualização é do tipo 'mandatory', que
                          significa que o usuário não tem poder sobre a aceitar
                          a atualização ou não, ela será instalada de qualquer
                          jeito.
                        </dd>
                        <dt>
                    ...
                    <p>
                      Agora podemos liberar uma versão pro android no ambiente
                      dev por exemplo, utilizando seguinte comando que irá
                      desabilitar a última versão lançada e lançará a nova:
                    </p>
                    <pre>
                      <SyntaxHighlighter
                        language="js"
                    ...
                    <br />
                    <h7 id="undoRelease" class="font-weight-bold">
                      Desfazendo a última release {"(Rollback)"}
                    </h7>
                    <br />
                    <p>
                      Caso seja verificado que a release lançada estava com
                      algum erro e for necessário fazer o rollback dela, podemos
                    ...
                    <br />
                    <h7 id="manageReleasesByAppCenter" class="font-weight-bold">
                    ...
                    <p>
                      ...
                      lançamento. Acessando o CodePush dentro do App Center
                      depois de lançar uma versão teremos a seguinte visão:
                    </p>
                    <div>
                      <img
                        height="250px"
                    ...
                    <dl>
                      ...
                      <dd>
                        <p>
                          Nos permite navegar entre todas as versões já
                          lançadas.
                        </p>
                      </dd>
                      <dt>
                      ...
                      <dd>
                        <p>
                          ...
                          liberar um release de forma gradativa, assim somente
                          uma certa quantidade de usuários receberá a
                          atualização, essa porcentagem pode ser aumentada mas
                          nunca diminuída.
                        </p>
                      </dd>
                      <dt>
                      ...
                      <dd>
                        <p>
                          Nos permite promover uma release de uma ambiente para
                          o outro, então podemos subir uma versão para o QA em
                          QAS e depois que for verificado que está tudo certo
                          podemos promover a mesma versão para PRD, se a versão
                          estiver apontando para QAS é importante que a promoção
                          aconteça após apontar para PRD.
                        </p>
                      </dd>
                      <dt>
              ...
              <Card className="card-user">
                ...
                <CardBody>
                  <p>
                    ...
                    <ul>
                      <li>
                        <a className="text-muted" href="#whyCodePush">
                          O que é o CodePush e porque utilizá-lo
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a className="text-muted" href="#createEnvironments">
                      ...
                      <li>
                        <a className="text-muted" href="#installCodePush">
                          Instalando o Code Push dentro do projeto
                        </a>
                      </li>
                      <li>
                        <a className="text-muted" href="#codePushConfiguring">
                          Configurando CodePush para lidar com as atualizações
                          em tempo real
                        </a>
                      </li>
                      <li>
                        <a className="text-muted" href="#whenUpdate">
                          Definindo quando será verificado e instalado
                          atualizações do CodePush
                        </a>
                      </li>
                      <li>
                        <a className="text-muted" href="#releaseUpdate">
                          Liberando atualizações pelo Code Push
                        </a>
                      </li>
                      <li>
                        <a className="text-muted" href="#undoRelease">
                          Desfazendo a última release (Rollback)
                        </a>
                      </li>
                      <li>
                        <a
                          className="text-muted"
                          href="#manageReleasesByAppCenter"
                        >
                          Gerenciando releases do Code Push através do App
                          Center
                        </a>
                      </li>
                    </ul>
